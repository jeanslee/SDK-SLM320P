...
enum {
    ...
    LV_KEY_POWER     = 31, //power key
    LV_KEY_VOLUME_DOWN   = 32, //volume down key
    LV_KEY_VOLUME_UP     = 33, //volume up key
    LV_KEY_TORCH    = 34, //torch key
    LV_KEY_PTT      = 35, //ptt key
    LV_KEY_ANSWER   = 36, //anwser key
    LV_KEY_0        = 37, //0 key
    LV_KEY_1        = 38, //1 key
    LV_KEY_2        = 39, //2 key
    LV_KEY_3        = 40, //3 key
    ...
    LV_KEY_DOT      = 48, //. key
    LV_KEY_PLUS     = 50, //+ key
    LV_KEY_BACK     = 51, //back key
    LV_KEY_MONEY    = 52, //money key
    LV_KEY_SCAN     = 53, //scan key
    LV_KEY_STORE    = 54, //store key
    LV_KEY_A        = 55, //6 key
    LV_KEY_B        =56 , //7 key
    LV_KEY_C        = 57, //8 key
    LV_KEY_D        = 58, //9 key
