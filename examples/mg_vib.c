...
{
	atDevice_t *vibrator = MG_atDeviceVibratorCreate();
	atDeviceOpen(vibrator);
	MG_atDeviceWrite(vibrator,POWER_LEVEL_1800MV,sizeof(POWER_LEVEL_1800MV));
	 MG_osiTracePrintf(LOG_TAG, "mg vibrator example enter..........");
