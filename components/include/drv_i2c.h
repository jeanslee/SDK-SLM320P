 ...
 *      - otherwise the i2c master instance
 */
drvI2cMaster_t *MG_drvI2cMasterAcquire(uint32_t name, drvI2cBps_t bps);
 ...
 * @param i2c   the i2c master
 */
void MG_drvI2cMasterRelease(drvI2cMaster_t *i2c);
 ...
 *      - false         fail
 */
bool MG_drvI2cWrite(drvI2cMaster_t *i2c, const drvI2cSlave_t *slave, const uint8_t *data, uint32_t length);
 ...
 *      - false         fail
 */
bool MG_drvI2cRead(drvI2cMaster_t *i2c, const drvI2cSlave_t *slave, uint8_t *buf, uint32_t length);
 ...
 *      - false         fail
 */
bool MG_drvI2cWriteRawByte(drvI2cMaster_t *i2c, uint8_t data, uint32_t cmd_mask);
 ...
 *      - false         fail
 */
bool MG_drvI2cReadRawByte(drvI2cMaster_t *i2c, uint8_t *data, uint32_t cmd_mask);
