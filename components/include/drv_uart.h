...
int MG_drvUartSend(drvUart_t *d, const void *data, size_t size);
int MG_drvUartReceive(drvUart_t *d, void *data, size_t size);
int MG_drvUartSendAll(drvUart_t *d, const void *data, size_t size, uint32_t timeout_ms);
drvUart_t *MG_drvUartCreate(uint32_t name, unsigned baud,drvUartParity_t parity,drvUartEventCB_t *UartCB);
bool MG_drvUartOpen(drvUart_t *d);
void MG_drvUartClose(drvUart_t *d);
void MG_drvUartDestroy(drvUart_t *d);
int MG_drvUartReadAvail(drvUart_t *d);
int MG_drvUartWriteAvail(drvUart_t *d);
