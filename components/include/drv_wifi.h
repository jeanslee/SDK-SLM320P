...
void MG_drvWifiClose(drvWifi_t *d);
...
bool MG_drvWifiScanAllChannel(drvWifi_t *d, wifiScanRequest_t *req, uint32_t round);
...
bool MG_drvWifiScanChannel(drvWifi_t *d, wifiScanRequest_t *req, uint32_t ch);
