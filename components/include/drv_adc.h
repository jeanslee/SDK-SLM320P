...
uint32_t MG_drvChargerGetVbatVol(void);
int32_t MG_drvAdcGetChannelVolt(uint32_t channel, int32_t scale);
int32_t getMAYIVbatVoltage(void);
int32_t getMAYIVbatTemp(void);
