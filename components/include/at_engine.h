...
atDevice_t *MG_atDeviceUartCreate(atDeviceUartConfig_t *cfg);
...
atDevice_t *MG_atVirtDeviceCreate(const atDeviceVirtConfig_t *cfg);
osiPipe_t* MG_atDeviceVirtCreate(unsigned name,osiPipeEventCallback_t cb);
bool MG_atDeviceVirtSend(osiPipe_t* pipe,const char*atcmd);
...
void MG_atDeviceDelete(atDevice_t *th);
...
bool MG_atDeviceOpen(atDevice_t *th);
...
void MG_atDeviceClose(atDevice_t *th);
...
int MG_atDeviceWrite(atDevice_t *th, const void *data, size_t size);
...
int MG_atDeviceRead(atDevice_t *th, void *data, size_t size);
...
int MG_atDeviceReadAvail(atDevice_t *th);
...
int MG_atDeviceWriteAvail(atDevice_t *th);
...
void MG_atDeviceSetBaudrate(atDevice_t *th, size_t baud);
...
void MG_atDeviceSetFormat(atDevice_t *th, atDeviceFormat_t format, atDeviceParity_t parity);
...
bool MG_atDeviceSetFlowCtrl(atDevice_t *th, atDeviceRXFC_t rxfc, atDeviceTXFC_t txfc);
...
void MG_atDeviceSetAutoSleep(atDevice_t *th, int timeout);
...
atDispatch_t *MG_atDispatchCreate(atDevice_t *device);
...
void MG_atDispatchDelete(atDispatch_t *th);
...
atDevice_t *MG_atDispatchGetDevice(atDispatch_t *th);
...
void atDeviceMayiFlowCtrl(bool on);
#ifdef __cplusplus
}
#endif
#endif
