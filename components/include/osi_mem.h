...
/*
 * same as osiMemSetCaller
 */
void MG_osiMemSetCaller(void *ptr, void *caller);
...
/*
 * same as osiMemAllocSize
 */
int MG_osiMemAllocSize(void *ptr);
...
/*
 * same as osiMemRefCount
 */
size_t MG_osiMemRefCount(void *ptr);
