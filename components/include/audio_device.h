...
bool MG_audevSetChannel(audevOutput_t outdev,audevInput_t indev);
bool MG_audevGetChannel(audevOutput_t *outdev,audevInput_t *indev);
...
bool MG_audevSetVoiceVolume(unsigned vol);
...
unsigned MG_audevGetVoiceVolume(void);
...
bool MG_audevSetPlayVolume(unsigned vol);
...
unsigned MG_audevGetPlayVolume(void);
...
bool MG_audevSetMicGain(uint8_t mode, uint8_t path, uint16_t anaGain, uint16_t adcGain);
...
bool MG_audevGetMicGain(uint8_t mode, uint8_t path, uint16_t *anaGain, uint16_t *adcGain);
...
bool MG_audevSetRecordMicGain(uint8_t mode, uint8_t path, uint16_t anaGain, uint16_t adcGain);
...
bool MG_audevGetRecordMicGain(uint8_t mode, uint8_t path, uint16_t *anaGain, uint16_t *adcGain);
...
bool MG_audevSetSideToneGain(uint8_t mode, uint8_t path, uint8_t level, int8_t sideGain);
...
bool MG_audevGetSideToneGain(uint8_t mode, uint8_t path, uint8_t level, int8_t *sideGain);
...
bool MG_audevPlayTone(audevTone_t tone, unsigned duration);
...
bool aw8733_audio_pa_init(void);
OSI_EXTERN_C_END
#endif
