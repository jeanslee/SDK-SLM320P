...
/* #undef CONFIG_CRASH_FLASH_ADDRESS */
 ...
 */
#define CONFIG_APP_FLASH_SIZE 0x2a0000
 ...
 */
#define CONFIG_FS_SYS_FLASH_ADDRESS 0x603b0000

/**
 * reserved NOR flash size for system file system
 */
#define CONFIG_FS_SYS_FLASH_SIZE 0x1b0000
 ...
 * execute on RAM.
 */
#define CONFIG_APPIMG_LOAD_FILE

/**
 * loadable app image file name
 */
#define CONFIG_APPIMG_LOAD_FILE_NAME "/appload.img"
 ...
 */
#define CONFIG_APP_RAM_SIZE 0x500000
 ...
 */
#define CONFIG_APP_FLASHIMG_RAM_OFFSET 0xe80000
 ...
 */
#define CONFIG_APP_FILEIMG_RAM_OFFSET 0xf80000

/**
 * PSRAM or DDR size for app image from RAM
 */
#define CONFIG_APP_FILEIMG_RAM_SIZE 0x40000
 ...
 */
#define CONFIG_BOARD_SIM1_DETECT_GPIO 14
...
/**
 * whether Meig module platform
 */
/* #undef CONFIG_BOARD_MG_MODULE_NAME_SLM320 */
#define CONFIG_BOARD_MG_MODULE_NAME_SLM320P on
/* #undef CONFIG_BOARD_MG_MODULE_NAME_SLM320PE */
/* #undef CONFIG_BOARD_MG_MODULE_NAME_MAYI */
/* #undef CONFIG_BOARD_MG_MODULE_NAME_SLM330 */
/* #undef CONFIG_BOARD_MG_MODULE_NAME_BAOLAN */
/* #undef CONFIG_BOARD_MG_MODULE_NAME_SLM320JW */
/* #undef CONFIG_BOARD_MG_MODULE_NAME_SLM320PWY */
/* #undef CONFIG_BOARD_MG_MODULE_NAME_SLM326 */
/* #undef CONFIG_BOARD_MG_MODULE_BAIFU326 */
/* #undef CONFIG_BOARD_MG_MODULE_BAIFU320 */
/**
 * whether to support GPS
 */
#define CONFIG_GPS_CHIP_TD1030 on

#define CONFIG_TTS_SUPPORT on

/**
 * whether watch dog is supported
 */
/* #undef CONFIG_WATCH_DOG_SUPPORT */
#endif
