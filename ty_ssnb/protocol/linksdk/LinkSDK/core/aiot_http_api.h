...
//新增POST 接口
int32_t aiot_http_post(void *handle, char *path, char *content, char**response, uint32_t* totalLen);

int32_t aiot_http_post_with_range(void *handle, char *path, char *content, char**response, uint32_t* totalLen, uint32_t startRange, uint32_t endRange);
