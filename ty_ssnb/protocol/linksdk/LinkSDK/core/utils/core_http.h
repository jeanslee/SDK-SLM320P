...
#define CORE_HTTP_DEFAULT_AUTH_TIMEOUT_MS          (10 * 1000)
#define CORE_HTTP_DEFAULT_SEND_TIMEOUT_MS          (10 * 1000)
#define CORE_HTTP_DEFAULT_RECV_TIMEOUT_MS          (20 * 1000)
#define CORE_HTTP_DEFAULT_HEADER_LINE_MAX_LEN      (128)
#define CORE_HTTP_DEFAULT_BODY_MAX_LEN             (20*1000)
#define CORE_HTTP_DEFAULT_DEINIT_TIMEOUT_MS        (2 * 1000)

#define CORE_HTTP_DEFAULT_CHUNKED_MAX_SIZE         (20*1000)
